...
public class Constant {
    ...
    public static final String CODIGO_PORCENTAJE5 = "CODIGO_PORCENTAJE5";
    public static final String VALOR = "VALOR";
    public static final String VALOR_IVA5 = "VALOR_IVA5";
    ...
    public static final String TIPOSUJETORETENIDO = "TIPOSUJETORETENIDO";
    ...
    public static final String CONTRIBUYENTE_RIMPE = "CONTRIBUYENTE_RIMPE";
    public static final String COD_SUSTENTO = "CODSUSTENTO";
    public static final String FECHA_REGISTRO_CONTABLE = "FECHAREGISTROCONTABLE";
    public static final String PAGO_LOC_EXT = "PAGOLOCEXT";
    public static final String TIPO_REGI = "TIPOREGI";
    public static final String TOTAL_COMPROBANTES_REEMBOLSO = "TOTALCOMPROBANTESREEMBOLSO";
    public static final String TOTAL_BASE_IMPONIBLE_REEMBOLSO = "TOTALBASEIMPONIBLEREEMBOLSO";
    public static final String TOTAL_IMPUESTO_REEMBOLSO = "TOTALIMPUESTOREEMBOLSO";
    public static final String TOTALSINIMPUESTOS = "TOTALSINIMPUESTOS";
    public static final String IMPORTETOTAL = "IMPORTETOTAL";
    public static final String COD_IMPUESTO_DOC_SUSTENTO = "CODIMPUESTODOCSUSTENTO";
    public static final String CODIGOPORCENTAJE = "CODIGOPORCENTAJE";
    public static final String VALOR_IMPUESTO = "VALORIMPUESTO";
    public static final String FECHA_PAGO_DIV = "FECHAPAGODIV";
    public static final String IM_RENTA_SOC = "IMRENTASOC";
    public static final String EJER_FIS_UT_DIV = "EJERFISUTDIV";
    public static final String NUM_CAJ_BAN = "NUMCAJBAN";
    public static final String PREC_CAJ_BAN = "PRECCAJBAN";
    public static final String FORMAPAGO = "FORMAPAGO";
    public static final String TOTAL = "TOTAL";
    public static final String PARTEREL = "PARTEREL";
    public static final String CODIGO_IMPUESTO_CERO = "CODIGO_IMPUESTO_CERO";
    ...
    public static final String FACTURA_C_SQL = "SELECT COD_EMPRESA, RUC_EMPRESA, RAZON_SOCIAL_EMPRESA, "
            ...
            + "AGENTE_RETENCION, REGIMEN_MICROEMPRESAS, CONTRIBUYENTE_RIMPE, BASE5, CODIGO_PORCENTAJE5, VALOR_IVA5 "
            + "FROM ";
    ...
    public static final String LIQUIDACION_COMPRA_C_SQL = "SELECT COD_EMPRESA, RUC_EMPRESA, "
            ...
            + "CLAVE_ACCESO, CODIGO_IMPUESTO, CODIGO_PORCENTAJE, BASE_IMPONIBLE, "
            + "VALOR, MONEDA, OBSERVACION, AGENTE_RETENCION, REGIMEN_MICROEMPRESAS, CONTRIBUYENTE_RIMPE, "
    ...
    public static final String FACTURA_C_SQL_MICROSOFT_SQL_SERVER = "SELECT TOP 20 COD_EMPRESA, RUC_EMPRESA, RAZON_SOCIAL_EMPRESA, "
            ...
            + "VALOR, MONEDA, OBSERVACION, BASE_IMPONIBLE_SIN_IVA, CODIGO_IMPUESTO_SIN_IVA, "
            + "CODIGO_PORCENTAJE_SIN_IVA, TARIFA_IVA_SIN_IVA, VALOR_IVA_SIN_IVA, PLACA, TOTAL_SUBSIDIO, "
            + "AGENTE_RETENCION, REGIMEN_MICROEMPRESAS, CONTRIBUYENTE_RIMPE "
            + "FROM ";
    ...
    public static final String RETENCION_C_SQL_MYSQL = "SELECT COD_EMPRESA, RUC_EMPRESA, RAZON_SOCIAL_EMPRESA, "
            ...
            + "EMAIL_RETENIDO, FECHA_RETENCION, TIPO_IDENT_SUJETO_RETENIDO, PARTEREL, "
            + "IDENTIFICACION_SUJETO_RETENIDO, PERIODO_FISCAL, ESTADO_SRI, VALORIMPUESTO, TIPOSUJETORETENIDO, "
            + "CLAVE_ACCESO_LOTE, AGENTE_RETENCION, REGIMEN_MICROEMPRESAS, CONTRIBUYENTE_RIMPE, CODSUSTENTO, "
            + "NUMDOCSUSTENTO, FECHAEMISIONDOCSUSTENTO, FECHAREGISTROCONTABLE, NUMAUTDOCSUSTENTO, PAGOLOCEXT, "
            + "TIPOREGI, TOTALCOMPROBANTESREEMBOLSO, TOTALBASEIMPONIBLEREEMBOLSO, TOTALIMPUESTOREEMBOLSO, TARIFA, "
            + "TOTALSINIMPUESTOS, IMPORTETOTAL, CODIMPUESTODOCSUSTENTO, CODIGOPORCENTAJE, BASEIMPONIBLE, CODDOCSUSTENTO "
    ...
    public static final String RETENCION_D_SQL = "SELECT TOTAL, FORMAPAGO, PRECCAJBAN, NUMCAJBAN, EJERFISUTDIV, "
            + "IMRENTASOC, FECHAPAGODIV, CODIGO, CODIGORETENCION, "
    ...
    public static final String NOTA_CREDITO_C_SQL_MYSQL = "SELECT COD_EMPRESA, RUC_EMPRESA, "
            ...
            + "CLAVE_ACCESO_LOTE, AGENTE_RETENCION, REGIMEN_MICROEMPRESAS, CONTRIBUYENTE_RIMPE, "
            + "CODIGO_IMPUESTO_CERO, CODIGO_PORCENTAJE_CERO, BASE_IMPONIBLE_CERO, VALOR_CERO "
    ...
    public static final String NOTA_CREDITO_C_SQL_ORACLE = "SELECT COD_EMPRESA, RUC_EMPRESA, "
            ...
            + "CLAVE_ACCESO_LOTE, AGENTE_RETENCION, REGIMEN_MICROEMPRESAS, CONTRIBUYENTE_RIMPE, "
            + "CODIGO_IMPUESTO_CERO, CODIGO_PORCENTAJE_CERO, BASE_IMPONIBLE_CERO, VALOR_CERO, "
            + "BASE5, CODIGO_PORCENTAJE5, VALOR_IVA5 "
            + "FROM V_NOTA_CREDITO_ELECTRONICA_C "
            + "WHERE ";
    ...
    public static final String NOTA_DEBITO_C_SQL_MYSQL = "SELECT COD_EMPRESA, RUC_EMPRESA, "
            ...
            + "CLAVE_ACCESO_LOTE, VALOR_TOTAL, AGENTE_RETENCION, REGIMEN_MICROEMPRESAS, CONTRIBUYENTE_RIMPE "
